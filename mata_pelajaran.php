...
function searchMatpel()
{
    $conn = mysqli_connect("localhost", "root", "", "sekolahan3");
    $kata = $_POST['kata'];
    $query = "SELECT * FROM matapelajaran WHERE kd_matpel LIKE('%$kata%') || nm_matpel LIKE('%$kata%') || jam LIKE('%$kata%')";
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="mata_pelajaran.php" class="active-menu">Mata Pelajaran</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- The Modal -->
                <form action="function.php?add_matpel" method="POST">
                    <div id="myModal" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <div>
                                <label for="kd_matpel">Masukkan Kode Mata Pelajaran : </label>
                                <input type="text" name="kd_matpel" class="form-control" id="kd_matpel">
                            </div>
                            <div>
                                <label for="nm_matpel">Masukkan Nama Mata Pelajaran : </label>
                                <input type="text" name="nm_matpel" class="form-control" id="nm_matpel">
                            </div>
                            <div>
