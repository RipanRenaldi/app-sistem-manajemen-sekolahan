        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <table class="table table-hover">
                    ...
                    <?php $kguru = $mhs->getkGuru($item['kd_guru']);

                    $no = 1;
                    if (isset($_POST['cari'])) {
                        $kelas = searchKelas();
                    }
                    foreach ($kguru as $kls) : ?>
                        ...
                        <tr>
                            ...
                            <td><?= $kls['nm_siswa'] ?></td>
                            <td><?= $kls['email'] ?></td>
                            <td><?= $kls['jurusan'] == 1 ? 'Matematika & Ilmu Alam' : ($kls['jurusan'] == 2 ? 'Ilmu Ilmu Sosial' : ($kls['jurusan'] == 3 ? 'Keagamaan' : 'Bahasa'))  ?></td>
                            <!-- <td>
                                <a href="#"><button class="btn btn-xs btn-success" style="display:inline-block">Edit</button></a>
