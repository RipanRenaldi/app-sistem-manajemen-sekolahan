...
function searchUser()
{
    ...
    $kata = $_POST['kata'];
    $query = "SELECT * FROM user JOIN roleuser on user.id_role = roleuser.id WHERE username LIKE('%$kata%') || role LIKE('%$kata%')";
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="user.php">User</a>
                    </li>
                </ul>
            </div>
        </nav>
